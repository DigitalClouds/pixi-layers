...
import { DisplayObject, RenderTexture, Rectangle, Renderer, settings, Container } from 'pixi.js';
...
export class LayerTextureCache {
    ...
    initRenderTexture(renderer?: Renderer) {
